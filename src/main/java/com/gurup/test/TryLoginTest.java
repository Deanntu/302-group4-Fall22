	...
	public void testLogin() {
		...
		try {
			...
			assertEquals(AccountOperationResults.WRONG_MAIL_FORMAT,
					Manager.loginAccount("esma", "123", "123", "a@acom"));
			assertEquals(AccountOperationResults.WRONG_CREDENTIAL,
					Manager.loginAccount("esmaa", "123", "123", "me@eeray.com"));
			assertEquals(AccountOperationResults.WRONG_CREDENTIAL,
					Manager.loginAccount("esma", "123", "123", "me@eeray.comm"));
			assertEquals(AccountOperationResults.SUCCESS,
					Manager.loginAccount("esma", "12345", "12345", "me@eeray.com"));
		} catch (Exception e) {
