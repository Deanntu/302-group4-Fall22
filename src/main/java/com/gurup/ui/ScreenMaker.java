...
public class ScreenMaker {
	public RunningModeScreen createScreen(Player player, MovementController movementController, KeyClickController keyClickController, Room room) {
		RunningModeScreen runningModeScreen = new RunningModeScreen(player, movementController, keyClickController, room);
